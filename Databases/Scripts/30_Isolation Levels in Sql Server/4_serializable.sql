...
Result: Dirty Read is not allowed in 'SERIALIZABLE'
*/
...
Result: Non-Repeatable read is not allowed in 'SERIALIZABLE'.
...
Result: Phanthom read is not allowed in 'SERIALIZABLE'.
