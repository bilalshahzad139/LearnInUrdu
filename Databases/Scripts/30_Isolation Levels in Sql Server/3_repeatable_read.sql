...
Result: Dirty Read is not allowed in 'REPEATABLE'
...
-- After delay, we are accessing same row and we'll see update result.

Result: Non-Repeatable read is not allowed in 'REPEATABLE'.
...
Result: Phanthom read is allowed in 'REPEATABLE'.
*/
